...
SEARCH_PAGE = "http://www.amicabile.de/chessella/games/searchgamesform.action"
...
def get_games_number():
    ...
    chess_games_matcher = re.search('Search in ([0-9\.]+) \( mostly annotated \) chess games\!', search_in)
